...
# Post Mortem
![What is the Economics often gets lost in RCTs. We often end up with a clever RCT but one that does not do any 'real' economics. Maybe we should have an RCT evaluating our field.](rct-your-way-to-policy/what-is-economics.png)
